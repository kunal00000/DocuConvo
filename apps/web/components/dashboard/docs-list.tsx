...
<div className=" flex w-full flex-wrap gap-5  ">
          ...
          {userProjects.map((item:singleDocsItem) => (
            <Link href={"/dashboard/"+item.id} key={item.id} ><div className="  w-[250px]  rounded-sm border  p-5 text-start cursor-pointer hover:shadow-sm hover:border-black hover:scale-[102%]   duration-300 ">
