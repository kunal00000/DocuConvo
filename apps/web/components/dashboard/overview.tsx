      ...
      <div className="space-y-2">
        <div className="space-y-2">
          ...
          <p className=" text-base text-gray-700 2xl:max-w-sm">
            Interact with your documentation conversational system which make
            your documentaion loved by by your users
          </p>
        </div>
        <div className="flex items-center space-x-2">
          <Link
            target="_blank"
            className="font-regular text-foreground bg-button hover:bg-selection border-button hover:border-button-hover focus-visible:outline-brand-600 relative inline-flex translate-y-[1px] cursor-pointer items-center justify-center space-x-2 rounded-md border px-2.5 py-1 text-center text-xs shadow-sm outline-none outline-0 transition-all duration-200 ease-out focus-visible:outline-4 focus-visible:outline-offset-1"
            ...
            <div className="">
              <div className="border-panel-border-interior-light dark:border-panel-border-interior-dark border-t px-6 py-4">
                <div className="input-mono grid gap-2 text-sm md:grid md:grid-cols-12">
                  <div className="col-span-4 flex flex-col space-y-2">
                    ...
                    >
                      <div className="space-y-2">
                        <p className="text-sm font-semibold">DocuConvo Key</p>
                      </div>
                    </label>
                  </div>
                  <div className="col-span-8">
                    <div className="">
                      <div className="relative">
                        <input
                          type="text"
                          className="peer/input text-foreground focus-visible:border-foreground-muted focus-visible:ring-background-control placeholder-foreground-muted bg-foreground/[.026] border-control box-border block w-full truncate rounded-md border px-4 py-2 pr-20 text-sm opacity-50 shadow-sm outline-none transition-all focus:ring-2 focus:ring-current focus-visible:shadow-md"
                          readOnly=""
              ...
              <div className="border-panel-border-interior-light dark:border-panel-border-interior-dark border-t">
                <div className="bg-surface-100 relative min-h-[200px] px-4 py-6">
                  ...
                  <div className="relative">
                    <pre className="peer/input text-foreground focus-visible:border-foreground-muted focus-visible:ring-background-control placeholder-foreground-muted bg-foreground/[.026] border-control box-border block w-full whitespace-pre-line rounded-md rounded-t-none border px-4 py-2 text-sm opacity-50 shadow-sm outline-none transition-all focus:ring-2 focus:ring-current focus-visible:shadow-md">
...
const { answer, message, error } = await docuconvo.search(searchQuery)`
                      ...
                      className="font-regular text-foreground bg-button hover:bg-selection border-button hover:border-button-hover focus-visible:outline-brand-600 absolute right-2 top-2 inline-flex cursor-pointer items-center justify-center space-x-2 rounded-md border px-2.5 py-1 text-center text-xs shadow-sm outline-none outline-0 transition-all duration-200 ease-out focus-visible:outline-4 focus-visible:outline-offset-1"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={14}
