...
{...register("projectName", { required: true })}
          ...
          <div className=" mt-3 grid gap-1">
            <Label className="" htmlFor="website_url">
            Website  Url
            </Label>
            <Input
              id="website_url"
...
{...register("match", { required: true })}
          ...
          <div className=" mt-3 grid gap-1">
            <Label className="" htmlFor="cssSelector">
...
{...register("cssSelector", { required: true })}
          ...
          <div className=" mt-3 grid gap-1">
            <Label className="" htmlFor="pinecone_ApiKey">
                Pinecone API Key
            </Label>
            <Input
              id="pinecone_ApiKey"
...
{...register("pinecone_ApiKey", { required: true })}
          ...
          <div className=" mt-3 grid gap-1">
            <Label className="" htmlFor="pinecone_environment">
...
{...register("pinecone_environment", { required: true })}
          ...
          <div className=" mt-3 grid gap-1">
            <Label className="" htmlFor="pinecone_indexName">
                Pinecone Index Name
            </Label>
            <Input
...
{...register("pinecone_indexName", { required: true })}
          ...
          <div className=" mt-3 grid gap-1">
            <Label className="" htmlFor="openai_ApiKey">
                OpenAI API Key
            </Label>
            <Input
              id="openai_ApiKey"
